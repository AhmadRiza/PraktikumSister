...
public class Soal2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtFile.setText("No File Choosen");

        jButton2.setText("Read Image");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        imageFile = FileHelper.browseFileDialog(this);
        if (imageFile != null) {
            txtFile.setText(imageFile.getName());
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            // TODO add your handling code here:
            FileHelper.saveImageFileDialog(ImageIO.read(imageFile), this);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(imageFile!=null){
            try {
                ImageHelper.showImage(imageFile);
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        }
